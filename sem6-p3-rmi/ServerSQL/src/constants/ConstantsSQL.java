...
/**
 * <p>Класс констант, необходимых для работы с базой данных.
 * Здесь имеются настройки для работы со схемой, а также sql-запросы.
 *
...
public class ConstantsSQL {
     ...
     * TCP/IP MySQL сервера, логин, пароль и класс драйвера.
     */
    ...
    /**
     * SQL-запросы для работы с квитанциями.
     */
